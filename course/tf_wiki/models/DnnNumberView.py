...
class MLP(tf.keras.Model):
    def __init__(self):
        super().__init__()
        self.dense1 = tf.keras.layers.Dense(units=100, activation=tf.nn.relu6)
        self.dense4 = tf.keras.layers.Dense(units=100, activation=tf.nn.relu6)
        self.dense2 = tf.keras.layers.Dense(units=10, activation=tf.nn.relu6)
